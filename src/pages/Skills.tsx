        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {subjects.filter(s => s.category === 'SKILL').map((s, i) => {
              ...
              const isComingSoon = (s as any).status === 'soon' || (chapCount === 0 && (s as any).category === 'skill');
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={cn(
                      "w-full text-left p-5 transition-colors relative overflow-hidden",
                      ...
                      >
                        {isLoadingChapters ? (
                          ...
                          chapters.map((ch) => (
                            <button
                              key={ch.id}
                              onClick={() => navigate(`/notes/${s.slug}/${ch.slug}`)}
